...
$! for "git bisect reset" option.
$!
$ TEST_NAME = "GIT_BISECT_RESET"
...
$ FIRST_7_CHARS = F$EXTRACT(0, 7, BAD_ID)
$ WRITE OUTPUT_FILE_2 "Previous HEAD position was ''FIRST_7_CHARS' Bad version"
$ WRITE OUTPUT_FILE_2 "Switched to branch 'master'"
$ CLOSE OUTPUT_FILE_2
$!
...
$ PIPE git bisect reset | @'OUT_DIR'TEE 'CWD''TEST_NAME'.OUT
